...
async function GET(req, res) {
    ...
    try {
        ...
        const existingShop = await sessions.findOne({
            shop
        });
        if (existingShop) {
        ...
        const hostWithoutProtocol = ("TURBOPACK compile-time value", "https://a678-223-178-208-191.ngrok-free.app").replace(/^https?:\/\//, '');
